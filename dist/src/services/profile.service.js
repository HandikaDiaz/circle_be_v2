...
function updateProfile(updateDTOFromBody, id) {
    return __awaiter(this, void 0, void 0, function* () {
        yield Promise.all(Object.entries(updateDTOFromBody).map((_a) => __awaiter(this, [_a], void 0, function* ([key, value]) {
            if (typeof value !== 'string') {
                const url = (yield (0, cloudinary_1.default)(value))[0].url;
