...
function createLike(userId, threadId) {
    return __awaiter(this, void 0, void 0, function* () {
        const exist = yield likeRepository.findLike(userId, threadId);
        if (exist) {
            yield likeRepository.deleteLike(userId, threadId);
            return 'Unlike successfully';
        }
        yield likeRepository.createLike(userId, threadId);
        return 'Like successfully';
    });
}
function checkLike(userId, threadId) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield likeRepository.findLike(userId, threadId);
    });
}
